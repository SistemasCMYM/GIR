...
<?php $__env->startSection('title', 'Ficha de Datos Generales'); ?>
...
<?php $__env->startSection('content'); ?>
            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        <a href="<?php echo e(route('gestion-instrumentos.cuestionarios.index')); ?>" class="btn btn-outline-secondary">
                    ...
                    <div class="card-body">
                        <form id="datosGeneralesForm">
                            ...
                            <input type="hidden" id="employee_id" name="employee_id"
                                value="<?php echo e(session('user_data.employee_id') ?? 'EMP_001'); ?>">
                            ...
                            <div class="row mb-4">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" id="nombre_completo" name="nombre_completo"
                                        value="<?php echo e(old('nombre_completo', ($empleado->primerNombre ?? '') . ' ' . ($empleado->segundoNombre ?? '') . ' ' . ($empleado->primerApellido ?? '') . ' ' . ($empleado->segundoApellido ?? ''))); ?>"
                                        required>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="ano_nacimiento" name="ano_nacimiento"
                                        min="1940" max="<?php echo e(date('Y') - 16); ?>" placeholder="Ej: 1985" required>
    ...
    <script>
        ...
        function guardarBorrador() {
            ...
            fetch('<?php echo e(route('gestion-instrumentos.api.datos-generales.borrador')); ?>', {
                    method: 'POST',
                    headers: {
        ...
        document.getElementById('datosGeneralesForm').addEventListener('submit', function(e) {
            ...
            fetch('<?php echo e(route('gestion-instrumentos.api.datos-generales.completar')); ?>', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                window.location.href =
                                    '<?php echo e(route('gestion-instrumentos.cuestionarios.index')); ?>';
                            }
                        });
                    } else {
                        throw new Error(data.message);
        ...
        async function cargarDatosExistentes() {
            try {
                ...
                const response = await fetch(
                    `<?php echo e(route('gestion-instrumentos.api.datos-generales.obtener', ':employeeId')); ?>`.replace(
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\José Espinel\OneDrive - CM&M ASESORES DE SEGURO LIMITADA\Documentos - Grupo IT\APP-GIR365-V2\resources\views/admin/gestion-instrumentos/cuestionarios/datos-generales.blade.php ENDPATH**/ ?>