...
<?php $__env->startSection('title', 'Estadísticas de Encuesta'); ?>

<?php $__env->startPush('styles'); ?>
    <link href="<?php echo e(asset('css/estadisticas-encuestas.css')); ?>" rel="stylesheet">
<?php $__env->stopPush(); ?>
...
<?php $__env->startSection('content'); ?>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="text-muted mb-0">
                            <?php echo e($encuesta->titulo ?? 'Encuesta sin título'); ?>
            ...
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="card stats-card border-0 bg-gradient-primary text-white fade-in-up">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h3 class="mb-0 fw-bold"><?php echo e($estadisticas['total_respuestas'] ?? 0); ?></h3>
            ...
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="card stats-card border-0 bg-gradient-success text-white fade-in-up">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h3 class="mb-0 fw-bold"><?php echo e($estadisticas['respuestas_completas'] ?? 0); ?></h3>
            ...
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="card stats-card border-0 bg-gradient-warning text-white fade-in-up">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h3 class="mb-0 fw-bold"><?php echo e(number_format($estadisticas['tasa_completitud'] ?? 0, 1)); ?>%
                                </h3>
            ...
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="card stats-card border-0 bg-gradient-info text-white fade-in-up">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h3 class="mb-0 fw-bold"><?php echo e($estadisticas['tiempo_promedio'] ?? 0); ?>m</h3>
                                    ...
                                    <div class="col-lg-6 mb-4">
                                        <div class="card border">
                                            <div class="card-header bg-light">
                                                <h6 class="mb-0">
                                                    Pregunta <?php echo e($index + 1); ?>: <?php echo e($pregunta['tipo'] ?? 'Sin tipo'); ?>

                                                </h6>
                                                <small
                                                    class="text-muted"><?php echo e(Str::limit($pregunta['texto'] ?? 'Sin texto', 100)); ?></small>
                                            </div>
                                            <div class="card-body">
                                                <?php switch($pregunta['tipo'] ?? 'escala_likert'):
                                                    case ('escala_likert'): ?>
                                                        <canvas id="pregunta<?php echo e($index + 1); ?>Chart" height="150"></canvas>
                                                    <?php break; ?>

                                                    <?php case ('escala_numerica'): ?>
                                                        <canvas id="pregunta<?php echo e($index + 1); ?>Chart" height="150"></canvas>
                                                    <?php break; ?>

                                                    <?php case ('opcion_multiple'): ?>
                                                    <?php case ('seleccion_multiple'): ?>
                                                        <canvas id="pregunta<?php echo e($index + 1); ?>Chart" height="200"></canvas>
                                                    <?php break; ?>
                                                                            ...
                                                                            <td>
                                                                                <div class="progress" style="height: 20px;">
                                                                                    <div class="progress-bar bg-info"
                                                                                        style="width: <?php echo e(rand(60, 95)); ?>%">
                                                                                        <?php echo e(number_format(rand(30, 50) / 10, 1)); ?>

                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                                                            <td><?php echo e(rand(15, 50)); ?></td>
                                                                        </tr>
                                                    ...
                                                    <?php case ('respuesta_abierta'): ?>
                                                        <div class="alert alert-info">
                                                            <h6><i class="fas fa-comments"></i> Resumen de Respuestas Abiertas</h6>
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <strong>Total respuestas:</strong> <?php echo e(rand(10, 30)); ?>

                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <strong>Promedio palabras:</strong> <?php echo e(rand(15, 45)); ?>
                                                            ...
                                                            <div class="mt-2">
                                                                ...
                                                                ?>
                                                                <?php $__currentLoopData = array_slice($palabras, 0, 5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $palabra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <span
                                                                        class="badge bg-secondary me-1"><?php echo e($palabra); ?></span>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </div>
                                                        </div>
                                                    <?php break; ?>
    ...
    <script>
        ...
        <?php if(isset($preguntas) && count($preguntas) > 0): ?>
            <?php $__currentLoopData = $preguntas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pregunta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(in_array($pregunta['tipo'] ?? 'escala_likert', [
                        'escala_likert',
                        'escala_numerica',
                        'opcion_multiple',
                        'seleccion_multiple',
                    ...
                    const ctx<?php echo e($index + 1); ?> = document.getElementById('pregunta<?php echo e($index + 1); ?>Chart');
                    if (ctx<?php echo e($index + 1); ?>) {
                        new Chart(ctx<?php echo e($index + 1); ?>.getContext('2d'), {
                            type: '<?php echo e(in_array($pregunta['tipo'] ?? 'escala_likert', ['opcion_multiple', 'seleccion_multiple']) ? 'bar' : 'bar'); ?>',
                            data: {
                                labels: <?php echo json_encode($pregunta['opciones'] ?? ['Opción 1', 'Opción 2', 'Opción 3']); ?>,
                                datasets: [{
                                    label: 'Respuestas',
                                    data: [
                                        <?php echo e(implode(', ',array_map(function () {return rand(5, 25);}, range(1, count($pregunta['opciones'] ?? [1, 2, 3]))))); ?>

                                    ],
                                    backgroundColor: '<?php echo e($colores[array_rand($colores)] ?? '#0d6efd'); ?>'
                                }]
                            },
                            options: {
                                responsive: true,
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\José Espinel\OneDrive - CM&M ASESORES DE SEGURO LIMITADA\Documentos - Grupo IT\APP-GIR365-V2\resources\views/admin/gestion-instrumentos/encuestas/informes.blade.php ENDPATH**/ ?>