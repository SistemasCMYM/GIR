...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'GIR-365 - Sistema Integral de Riesgos'); ?></title>
    <!-- Bootstrap CSS -->
    ...
    <link href="<?php echo e(asset('css/gir-custom-colors.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/gir365.css')); ?>" rel="stylesheet">
...
<body class="gir-silva-dashboard tw-bg-[#f5f7fb] tw-text-gray-900" data-sidebar="default" data-leftbar-size="default"
    ...
    <?php if ($__env->exists('gir365.auth_logic_original')) echo $__env->make('gir365.auth_logic_original', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    ...
                    <ul>
                        <li class="menuitem-active">
                            <a href="<?php echo e(route('dashboard')); ?>"
                                class="tp-link <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>">
                        ...
                        <li class="menuitem-active">
                            <a href="<?php echo e(route('hallazgos.index')); ?>"
                                class="tp-link <?php echo e(request()->routeIs('hallazgos.*') ? 'active' : ''); ?>">
                        ...
                        <li class="menuitem-active">
                            <a href="<?php echo e(route('psicosocial.index')); ?>"
                                class="tp-link <?php echo e(request()->routeIs('psicosocial.*') ? 'active' : ''); ?>">
                        ...
                        <li class="menuitem-active">
                            <a href="<?php echo e(route('empresa.index')); ?>"
                                class="tp-link <?php echo e(request()->routeIs('empresa.*') ? 'active' : ''); ?>">
                                <i class="fas fa-building"></i>
                                <span>Administración de Empresa</span>
                            </a>
                        </li>
                        <li class="menuitem-active">
                            <a href="<?php echo e(route('gestion-instrumentos.index')); ?>" class="tp-link">
                        ...
                        <?php if(!empty($isSuper) && $isSuper): ?>
                            ...
                            <li class="menuitem-active">
                                <a href="<?php echo e(route('configuracion.index')); ?>"
                                    class="tp-link <?php echo e(request()->routeIs('configuracion.*') ? 'active' : ''); ?>">
                            ...
                            <button
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <span
                                            class="tw-text-white tw-font-semibold tw-text-sm"><?php echo e($userInitials); ?></span>
                                    </div>
                                </div>
                                <div
                                    class="user-info tw-hidden md:tw-flex tw-flex-col tw-items-start tw-leading-tight tw-mr-2">
                                    <span
                                        class="user-name tw-font-medium tw-text-sm tw-text-gray-800"><?php echo e($userName); ?></span>
                                    <span
                                        class="user-role tw-text-xs tw-text-gray-500 tw-truncate tw-max-w-28"><?php echo e($empresaName); ?></span>
                                </div>
                                ...
                                <li class="tw-px-3 tw-py-3 tw-border-b tw-border-gray-100 tw-mb-2">
                                    <div class="tw-flex tw-items-center">
                                        <div
                                            ...
                                            <div
                                                class="tw-w-full tw-h-full tw-bg-gradient-to-br tw-from-gir-primary-500 tw-to-gir-gold-500 tw-flex tw-items-center tw-justify-center">
                                                <span class="tw-text-white tw-font-semibold"><?php echo e($userInitials); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                    ...
                    <div class="row align-items-center">
                        <div class="col-12 col-md-6 text-center text-md-start mb-2 mb-md-0">
                            <span class="text-dark fw-medium">
                                &copy; <?php echo e(date('Y')); ?> <strong>GIR-365</strong> -
                                <?php echo e($empresaData->razon_social ?? 'Sistema'); ?>

                            </span>
                        </div>
                        <div class="col-12 col-md-6 text-center text-md-end">
                            <span class="text-muted small">
                                Powered by Laravel <?php echo e(app()->version()); ?> & MongoDB
                            </span>
                        </div>
                    </div>
                </div>
    ...
    <?php echo app('Illuminate\Foundation\Vite')('resources/js/pages/analytics-dashboard.init.js'); ?>
            ...
            lockOverlay.innerHTML = `
                <div class="lock-screen-card tw-bg-white tw-rounded-xl tw-shadow-2xl tw-p-8 tw-max-w-md tw-w-full tw-mx-4">
                    ...
                    <div class="tw-text-center tw-mt-6">
                        <a href="<?php echo e(route('logout')); ?>" class="tw-text-red-600 tw-text-sm tw-hover:text-red-700 tw-transition-colors" 
                           onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                            Sign out instead
                        </a>
                    </div>
...
<?php /**PATH C:\Users\José Espinel\OneDrive - CM&M ASESORES DE SEGURO LIMITADA\Documentos - Grupo IT\APP-GIR365-V2\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>