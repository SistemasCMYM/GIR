...
<?php $__env->startSection('title', 'Detalles del Diagnóstico Psicosocial'); ?>
    ...
    <div class="container-fluid py-4">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="<?php echo e(route('psicosocial.index')); ?>">
                        <i class="fas fa-brain"></i> Psicosocial
                    </a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">
                    <i class="fas fa-chart-bar"></i>
                    <?php echo e(isset($diagnostico) ? 'Información Diagnóstico' : 'Resumen General'); ?>
            ...
            <div class="container-fluid">
                <div class="row mt-3">
                    <div class="col-12 text-center">
                        <a href="<?php echo e(route('psicosocial.diagnostico.resultados', $diagnostico->id)); ?>"
                            class="btn btn-success">
                            <i class="fas fa-chart-bar"></i> Ver Resultados Grupales
                        </a>
                        <a href="#" class="btn btn-primary" onclick="exportarInforme('<?php echo e($diagnostico->id); ?>')">
                            <i class="fas fa-file-export"></i> Exportar Informe
                        </a>
                        <a href="#" class="btn btn-info" onclick="imprimirInforme('<?php echo e($diagnostico->id); ?>')">
                            <i class="fas fa-print"></i> Imprimir
                        </a>
                        <a href="<?php echo e(route('psicosocial.index')); ?>" class="btn btn-secondary ms-auto">
                            <i class="fas fa-arrow-left"></i> Volver al Inicio
                        </a>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <dl class="row">
                                            ...
                                            <dd class="col-sm-8"><?php echo e($diagnostico->descripcion ?? 'No especificado'); ?></dd>

                                            <dt class="col-sm-4">Clave:</dt>
                                            <dd class="col-sm-8"><?php echo e($diagnostico->clave ?? 'No especificado'); ?></dd>

                                            <dt class="col-sm-4">Empresa:</dt>
                                            <dd class="col-sm-8">
                                                <span class="badge gir-bg-gradient text-white px-3 py-2">
                                                    <i
                                                        class="fas fa-building me-1"></i><?php echo e($empresaNombre ?? 'No especificado'); ?>
                                            ...
                                            <dd class="col-sm-8">
                                                <span class="badge gir-bg-secondary text-dark px-3 py-2">
                                                    <i
                                                        class="fas fa-user-tie me-1"></i><?php echo e($profesionalNombre ?? 'No especificado'); ?>
                                    ...
                                    <div class="col-md-6">
                                        <dl class="row">
                                            ...
                                            <dd class="col-sm-8">
                                                <?php echo e($diagnostico->created_at ? $diagnostico->created_at->format('d/m/Y H:i') : 'Sin fecha'); ?>

                                            </dd>

                                            <dt class="col-sm-4">Última Actualización:</dt>
                                            <dd class="col-sm-8">
                                                <?php echo e($diagnostico->updated_at ? $diagnostico->updated_at->format('d/m/Y H:i') : 'Sin fecha'); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-6 mb-3">
                                        <div class="small-box bg-success">
                                            <div class="inner">
                                                <h3><?php echo e($totalCompletadas); ?></h3>
                                                <p>Completadas</p>
                                            </div>
                                            <div class="icon">
                                    ...
                                    <div class="col-md-3 col-6 mb-3">
                                        <div class="small-box bg-warning">
                                            <div class="inner">
                                                <h3><?php echo e($totalPendientes); ?></h3>
                                                <p>Pendientes</p>
                                            </div>
                                            <div class="icon">
                                    ...
                                    <div class="col-md-3 col-6 mb-3">
                                        <div class="small-box bg-gradient-navy">
                                            <div class="inner">
                                                <h3><?php echo e($porcentajeCompletado); ?>%</h3>
                                                <p>Completado</p>
                                            </div>
                                            <div class="icon">
                                            ...
                                            <div class="card-body">
                                                <div class="progress">
                                                    <div class="progress-bar bg-success"
                                                        style="width: <?php echo e($totalHojas > 0 ? (($estadosIntralaboral['completado'] ?? 0) / $totalHojas) * 100 : 0); ?>%">
                                                        <?php echo e($estadosIntralaboral['completado'] ?? 0); ?> Completados
                                                    </div>
                                                    <div class="progress-bar bg-warning"
                                                        style="width: <?php echo e($totalHojas > 0 ? (($estadosIntralaboral['en_progreso'] ?? 0) / $totalHojas) * 100 : 0); ?>%">
                                                        <?php echo e($estadosIntralaboral['en_progreso'] ?? 0); ?> En Progreso
                                                    </div>
                                                    <div class="progress-bar bg-secondary"
                                                        style="width: <?php echo e($totalHojas > 0 ? (($estadosIntralaboral['pendiente'] ?? 0) / $totalHojas) * 100 : 0); ?>%">
                                                        <?php echo e($estadosIntralaboral['pendiente'] ?? 0); ?> Pendientes
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-12 mb-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="progress">
                                                    <div class="progress-bar bg-success"
                                                        style="width: <?php echo e($totalHojas > 0 ? (($estadosExtralaboral['completado'] ?? 0) / $totalHojas) * 100 : 0); ?>%">
                                                        <?php echo e($estadosExtralaboral['completado'] ?? 0); ?> Completados
                                                    </div>
                                                    <div class="progress-bar bg-warning"
                                                        style="width: <?php echo e($totalHojas > 0 ? (($estadosExtralaboral['en_progreso'] ?? 0) / $totalHojas) * 100 : 0); ?>%">
                                                        <?php echo e($estadosExtralaboral['en_progreso'] ?? 0); ?> En Progreso
                                                    </div>
                                                    <div class="progress-bar bg-secondary"
                                                        style="width: <?php echo e($totalHojas > 0 ? (($estadosExtralaboral['pendiente'] ?? 0) / $totalHojas) * 100 : 0); ?>%">
                                                        <?php echo e($estadosExtralaboral['pendiente'] ?? 0); ?> Pendientes
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-12 mb-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="progress">
                                                    <div class="progress-bar bg-success"
                                                        style="width: <?php echo e($totalHojas > 0 ? (($estadosEstres['completado'] ?? 0) / $totalHojas) * 100 : 0); ?>%">
                                                        <?php echo e($estadosEstres['completado'] ?? 0); ?> Completados
                                                    </div>
                                                    <div class="progress-bar bg-warning"
                                                        style="width: <?php echo e($totalHojas > 0 ? (($estadosEstres['en_progreso'] ?? 0) / $totalHojas) * 100 : 0); ?>%">
                                                        <?php echo e($estadosEstres['en_progreso'] ?? 0); ?> En Progreso
                                                    </div>
                                                    <div class="progress-bar bg-secondary"
                                                        style="width: <?php echo e($totalHojas > 0 ? (($estadosEstres['pendiente'] ?? 0) / $totalHojas) * 100 : 0); ?>%">
                                                        <?php echo e($estadosEstres['pendiente'] ?? 0); ?> Pendientes
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-12 mb-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="progress">
                                                    <div class="progress-bar bg-success"
                                                        style="width: <?php echo e($totalHojas > 0 ? (($estadosDatos['completado'] ?? 0) / $totalHojas) * 100 : 0); ?>%">
                                                        <?php echo e($estadosDatos['completado'] ?? 0); ?> Completados
                                                    </div>
                                                    <div class="progress-bar bg-warning"
                                                        style="width: <?php echo e($totalHojas > 0 ? (($estadosDatos['en_progreso'] ?? 0) / $totalHojas) * 100 : 0); ?>%">
                                                        <?php echo e($estadosDatos['en_progreso'] ?? 0); ?> En Progreso
                                                    </div>
                                                    <div class="progress-bar bg-secondary"
                                                        style="width: <?php echo e($totalHojas > 0 ? (($estadosDatos['pendiente'] ?? 0) / $totalHojas) * 100 : 0); ?>%">
                                                        <?php echo e($estadosDatos['pendiente'] ?? 0); ?> Pendientes
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="card-header bg-light">
                                ...
                                <div class="card-tools">
                                    <a href="#" class="btn btn-primary btn-sm"
                                        onclick="agregarNuevaHoja('<?php echo e($diagnostico->id); ?>')">
                                        <i class="fas fa-plus"></i> Agregar Evaluación
                                    </a>
                                </div>
                            </div>
                            <div class="card-body">
                                <?php if($hojasPaginadas->count() > 0): ?>
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $hojasPaginadas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hoja): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <?php if($empleado): ?>
                                                                ...
                                                                <?php echo e($empleado->primerApellido ?? ''); ?>

                                                            <?php else: ?>
                                                                <?php echo e(isset($hoja->nombre) ? $hoja->nombre : (isset($hoja['nombre']) ? $hoja['nombre'] : 'No especificado')); ?>

                                                            <?php endif; ?>
                                                        </td>
                                                        <td>
                                                            <?php if($empleado): ?>
                                                                <?php echo e($empleado->numeroDocumento ?? 'N/A'); ?>

                                                            <?php else: ?>
                                                                <?php echo e(isset($hoja->numero_documento) ? $hoja->numero_documento : (isset($hoja['numero_documento']) ? $hoja['numero_documento'] : 'N/A')); ?>

                                                            <?php endif; ?>
                                                        </td>
                                                        <td>
                                                            <?php if($empleado): ?>
                                                                <?php echo e($empleado->email ?? 'N/A'); ?>

                                                            <?php else: ?>
                                                                <?php echo e(isset($hoja->email) ? $hoja->email : (isset($hoja['email']) ? $hoja['email'] : 'N/A')); ?>
                                                        ...
                                                        <td>
                                                            ...
                                                            ?>
                                                            <span
                                                                class="badge bg-<?php echo e($colorRiesgo); ?>"><?php echo e($nivelRiesgoTexto); ?></span>
                                                        </td>
                                                        <td>
                                                            <strong><?php echo e(number_format($hoja->puntaje_total ?? 0, 1)); ?></strong>
                                                        </td>
                                                        <td>
                                                            <?php
                                                                $estadoDatos = function_exists('obtenerEstadoOficial')
                                                            ...
                                                            ?>
                                                            <?php echo function_exists('obtenerBadgeEstado')
                                                        ...
                                                        <td>
                                                            <div class="progress" style="height: 20px;">
                                                                <div class="progress-bar <?php if($progreso == 100): ?> bg-success <?php elseif($progreso >= 50): ?> bg-warning <?php else: ?> bg-info <?php endif; ?>"
                                                                    role="progressbar"
                                                                    style="width: <?php echo e($progreso); ?>%;"
                                                                    aria-valuenow="<?php echo e($progreso); ?>" aria-valuemin="0"
                                                                    aria-valuemax="100">
                                                                    <?php echo e($progreso); ?>%
                                                                </div>
                                                            </div>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group">
                                                                <a href="<?php echo e(route('psicosocial.evaluacion', ['diagnosticoId' => $diagnostico->id, 'hojaId' => $hoja->id])); ?>"
                                                                    class="btn btn-info btn-sm" title="Ver Test">
                                                                    <i class="fas fa-clipboard-check"></i>
                                                                </a>
                                                                <a href="<?php echo e(route('psicosocial.resumen.individual', $hoja->id)); ?>"
                                                                    class="btn btn-primary btn-sm"
                                                                    title="Resumen Individual">
                                                                    <i class="fas fa-chart-line"></i>
                                                                </a>
                                                                <button class="btn btn-success btn-sm" title="Copiar Link"
                                                                    onclick="copiarLinkEmpleado('<?php echo e($hoja->id); ?>')">
                                    ...
                                    <div class="d-flex justify-content-center mt-3">
                                        <?php echo e($hojasPaginadas->links()); ?>
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const riesgoData = [
                <?php echo e($nivelesRiesgo['sin_riesgo'] ?? 0); ?>,
                <?php echo e($nivelesRiesgo['bajo'] ?? 0); ?>,
                <?php echo e($nivelesRiesgo['medio'] ?? 0); ?>,
                <?php echo e($nivelesRiesgo['alto'] ?? 0); ?>,
                <?php echo e($nivelesRiesgo['muy_alto'] ?? 0); ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\José Espinel\OneDrive - CM&M ASESORES DE SEGURO LIMITADA\Documentos - Grupo IT\APP-GIR365-V2\resources\views/modules/psicosocial/diagnostico/show.blade.php ENDPATH**/ ?>