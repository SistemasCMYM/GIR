                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h4 class="card-title mb-2">
                                    ...
                                    <?php if(isset($diagnostico)): ?>
                                        Resumen de Diagnóstico - <?php echo e($diagnostico->descripcion); ?>
                                ...
                                <p class="text-muted mb-0">
                                    <?php if(isset($diagnostico)): ?>
                                        ...
                                        <?php echo e($empresaData['nombre'] ?? 'Empresa'); ?>
                                ...
                                <?php if(isset($diagnostico)): ?>
                                    <small class="text-muted">
                                        ...
                                        Creado: <?php echo e(\Carbon\Carbon::parse($diagnostico->created_at)->format('d/m/Y')); ?>

                                        <?php if($diagnostico->fecha_cierre): ?>
                                            | Cerrado:
                                            <?php echo e(\Carbon\Carbon::parse($diagnostico->fecha_cierre)->format('d/m/Y')); ?>
                            ...
                            <div class="text-end">
                                <a href="<?php echo e(route('psicosocial.index')); ?>" class="btn btn-outline-secondary">
                                    <i class="fas fa-arrow-left me-2"></i>Volver al Inicio
                                </a>
                                <?php if(isset($diagnostico)): ?>
                                    <a href="<?php echo e(route('psicosocial.show', $diagnostico->id)); ?>"
            ...
            <div class="row">
                <div class="col-12">
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle me-2"></i><?php echo e($mensaje); ?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="filtrosForm" method="GET"
                                action="<?php echo e(isset($diagnostico) ? route('psicosocial.resumen', $diagnostico->id) : route('psicosocial.resumen-general')); ?>">
                                <div class="row">
                                    <div class="col-md-3">
                                        <label class="form-label">Área</label>
                                        <select name="area" class="form-select">
                                            <option value="">Todas las áreas</option>
                                            <?php $__currentLoopData = $opciones['areas'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($area); ?>"
                                                    <?php echo e(request('area') == $area ? 'selected' : ''); ?>>
                                                    <?php echo e($area); ?>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select name="sede" class="form-select">
                                            ...
                                            <?php $__currentLoopData = $opciones['sedes'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sede): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($sede); ?>"
                                                    <?php echo e(request('sede') == $sede ? 'selected' : ''); ?>>
                                                    <?php echo e($sede); ?>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select name="ciudad" class="form-select">
                                            ...
                                            <?php $__currentLoopData = $opciones['ciudades'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ciudad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($ciudad); ?>"
                                                    <?php echo e(request('ciudad') == $ciudad ? 'selected' : ''); ?>>
                                                    <?php echo e($ciudad); ?>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select name="tipo_contrato" class="form-select">
                                            ...
                                            <?php $__currentLoopData = $opciones['tipos_contrato'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($tipo); ?>"
                                                    <?php echo e(request('tipo_contrato') == $tipo ? 'selected' : ''); ?>>
                                                    <?php echo e($tipo); ?>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-3">
                                        ...
                                        <select name="proceso" class="form-select">
                                            ...
                                            <?php $__currentLoopData = $opciones['procesos'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proceso): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($proceso); ?>"
                                                    <?php echo e(request('proceso') == $proceso ? 'selected' : ''); ?>>
                                                    <?php echo e($proceso); ?>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select name="forma" class="form-select">
                                            ...
                                            <option value="A" <?php echo e(request('forma') == 'A' ? 'selected' : ''); ?>>Forma A
                                            </option>
                                            <option value="B" <?php echo e(request('forma') == 'B' ? 'selected' : ''); ?>>Forma B
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 d-flex align-items-end">
                                        ...
                                        <a href="<?php echo e(isset($diagnostico) ? route('psicosocial.resumen', $diagnostico->id) : route('psicosocial.resumen-general')); ?>"
                ...
                <div class="col-md-4">
                    <div class="card bg-primary text-white">
                        <div class="card-body text-center">
                            ...
                            <h3 class="mb-0"><?php echo e($estadisticas['total']); ?></h3>
                ...
                <div class="col-md-4">
                    <div class="card bg-success text-white">
                        <div class="card-body text-center">
                            ...
                            <h3 class="mb-0"><?php echo e($estadisticas['completadas']); ?></h3>
                ...
                <div class="col-md-4">
                    <div class="card bg-warning text-white">
                        <div class="card-body text-center">
                            ...
                            <h3 class="mb-0"><?php echo e($estadisticas['pendientes']); ?></h3>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="legend-container">
                                        ...
                                        ?>
                                        <?php $__currentLoopData = $distribucion; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nivel => $datos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="legend-item mb-2">
                                                <span class="legend-color"
                                                    style="background-color: <?php echo e($colores[$nivel]); ?>"></span>
                                                <span class="legend-label"><?php echo e($etiquetas[$nivel]); ?></span>
                                                <span class="legend-value"><?php echo e(number_format($datos['porcentaje'], 1)); ?>%
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                ?>
                                <?php $__currentLoopData = $categoriasSociodemograficas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria => $titulo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-md-4 mb-4">
                                        <div class="card h-100">
                                            <div class="card-header">
                                                <h6 class="mb-0"><?php echo e($titulo); ?></h6>
                                            </div>
                                            <div class="card-body" style="min-height: 300px;">
                                                <canvas id="chart_<?php echo e($categoria); ?>"></canvas>
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-sm">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                <?php $__currentLoopData = $instrumentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $instrumento => $datos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td><strong><?php echo e($nombresInstrumentos[$instrumento]); ?></strong></td>
                                                        <td><?php echo e($datos['sin_riesgo'] ?? 0); ?></td>
                                                        <td><?php echo e($datos['bajo'] ?? 0); ?></td>
                                                        <td><?php echo e($datos['medio'] ?? 0); ?></td>
                                                        <td><?php echo e($datos['alto'] ?? 0); ?></td>
                                                        <td><?php echo e($datos['muy_alto'] ?? 0); ?></td>
                                                    </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </tbody>
                                        </table>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" id="seccion-5">
                            <p class="text-muted mb-3">
                                ...
                                <?php echo e($resumen['completo']['intralaboral_general']['poblacion'] ?? 0); ?> personas aplicaron
                                este test
                            </p>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-sm">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                        <?php $__currentLoopData = $dominios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dominio => $datos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td><strong><?php echo e($nombresDominios[$dominio] ?? $dominio); ?></strong>
                                                                </td>
                                                                <td><?php echo e($datos['contadores']['sin_riesgo'] ?? 0); ?></td>
                                                                <td><?php echo e($datos['contadores']['bajo'] ?? 0); ?></td>
                                                                <td><?php echo e($datos['contadores']['medio'] ?? 0); ?></td>
                                                                <td><?php echo e($datos['contadores']['alto'] ?? 0); ?></td>
                                                                <td><?php echo e($datos['contadores']['muy_alto'] ?? 0); ?></td>
                                                            </tr>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </tbody>
                                                </table>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-sm">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                        <?php $__currentLoopData = $dimensiones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dimension => $datos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td><strong><?php echo e($datos['nombre'] ?? $dimension); ?></strong>
                                                                </td>
                                                                <td><?php echo e($datos['contadores']['sin_riesgo'] ?? 0); ?></td>
                                                                <td><?php echo e($datos['contadores']['bajo'] ?? 0); ?></td>
                                                                <td><?php echo e($datos['contadores']['medio'] ?? 0); ?></td>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="alert alert-danger">
                                        ...
                                        <ul class="mb-0">
                                            <?php $__currentLoopData = $dimensiones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dimension => $datos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(($datos['contadores']['muy_alto'] ?? 0) > 0): ?>
                                                    <li><?php echo e($datos['nombre'] ?? $dimension); ?></li>
                                                <?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </ul>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="alert alert-warning">
                                        ...
                                        <ul class="mb-0">
                                            <?php $__currentLoopData = $dimensiones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dimension => $datos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(($datos['contadores']['alto'] ?? 0) > 0 || ($datos['contadores']['medio'] ?? 0) > 0): ?>
                                                    <li><?php echo e($datos['nombre'] ?? $dimension); ?></li>
                                                <?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </ul>
                                ...
                                <div class="col-md-4">
                                    <div class="alert alert-success">
                                        ...
                                        <ul class="mb-0">
                                            <?php $__currentLoopData = $dimensiones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dimension => $datos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(($datos['contadores']['bajo'] ?? 0) > 0 || ($datos['contadores']['sin_riesgo'] ?? 0) > 0): ?>
                                                    <li><?php echo e($datos['nombre'] ?? $dimension); ?></li>
                                                <?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </ul>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body" id="seccion-6">
                            <p class="text-muted mb-3">
                                <strong>Población Aplicable:</strong>
                                <?php echo e($resumen['completo']['intralaboral_a']['poblacion'] ?? 0); ?> personas aplicaron este test
                            </p>
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $dominiosA =
                                                                ...
                                                                [];
                                                        ?>
                                                        <?php $__currentLoopData = $dominiosA; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dominio => $datos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td><strong><?php echo e($nombresDominios[$dominio] ?? $dominio); ?></strong>
                                                                </td>
                                                                <td><?php echo e($datos['contadores']['sin_riesgo'] ?? 0); ?></td>
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $dimensionesA =
                                                                ...
                                                                [];
                                                        ?>
                                                        <?php $__currentLoopData = $dimensionesA; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dimension => $datos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td><strong><?php echo e($datos['nombre'] ?? $dimension); ?></strong>
                                                                </td>
                                                                <td><?php echo e($datos['contadores']['sin_riesgo'] ?? 0); ?></td>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body" id="seccion-7">
                            <p class="text-muted mb-3">
                                <strong>Población Aplicable:</strong>
                                <?php echo e($resumen['completo']['intralaboral_b']['poblacion'] ?? 0); ?> personas aplicaron este test
                            </p>
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $dominiosB =
                                                                ...
                                                                [];
                                                        ?>
                                                        <?php $__currentLoopData = $dominiosB; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dominio => $datos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td><strong><?php echo e($nombresDominios[$dominio] ?? $dominio); ?></strong>
                                                                </td>
                                                                <td><?php echo e($datos['contadores']['sin_riesgo'] ?? 0); ?></td>
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $dimensionesB =
                                                                ...
                                                                [];
                                                        ?>
                                                        <?php $__currentLoopData = $dimensionesB; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dimension => $datos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td><strong><?php echo e($datos['nombre'] ?? $dimension); ?></strong>
                                                                </td>
                                                                <td><?php echo e($datos['contadores']['sin_riesgo'] ?? 0); ?></td>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body" id="seccion-8">
                            <p class="text-muted mb-3">
                                <strong>Población Aplicable:</strong>
                                <?php echo e($resumen['completo']['extralaboral']['poblacion'] ?? 0); ?> personas aplicaron este test
                            </p>
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $dimensionesExtra =
                                                                ...
                                                                [];
                                                        ?>
                                                        <?php $__currentLoopData = $dimensionesExtra; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dimension => $datos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td><strong><?php echo e($datos['nombre'] ?? $dimension); ?></strong>
                                                                </td>
                                                                <td><?php echo e($datos['contadores']['sin_riesgo'] ?? 0); ?></td>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body" id="seccion-9">
                            <p class="text-muted mb-3">
                                <strong>Población Aplicable:</strong>
                                <?php echo e($resumen['completo']['estres']['poblacion'] ?? 0); ?> personas aplicaron este test
                            </p>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-sm">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                        <?php $__currentLoopData = $dimensionesEstres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dimension => $datos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td><strong><?php echo e($datos['nombre'] ?? $dimension); ?></strong>
                                                                </td>
                                                                <td><?php echo e($datos['contadores']['sin_riesgo'] ?? 0); ?></td>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Datos del resumen
            const resumen = <?php echo json_encode($resumen, 15, 512) ?>;
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\José Espinel\OneDrive - CM&M ASESORES DE SEGURO LIMITADA\Documentos - Grupo IT\APP-GIR365-V2\resources\views/modules/psicosocial/resumen_general.blade.php ENDPATH**/ ?>