    ...
    <style>
        ...
        * {
        ...
        .auth-layout {
            ...
            background: url('<?php echo e(asset('img/frente-edificio-moderno.jpg')); ?>') no-repeat center center;
    ...
    <div class="auth-layout">
        <div class="auth-card fade-in" data-aos="fade-up" data-aos-duration="600">
            ...
            <div class="auth-body" style="overflow-y: auto; max-height: calc(100% - 120px);">
                ...
                <form method="POST" action="<?php echo e(route('auth.nit.verify')); ?>" id="nitForm">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control-modern" id="nit" name="nit"
                            placeholder="Ejemplo: 900123456" value="<?php echo e(old('nit')); ?>" required
                ...
                <div class="text-center mt-4" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <a href="<?php echo e(route('landing')); ?>" class="btn-link-modern">
...
<?php /**PATH C:\Users\José Espinel\OneDrive - CM&M ASESORES DE SEGURO LIMITADA\Documentos - Grupo IT\APP-GIR365-V2\resources\views/admin/auth/nit.blade.php ENDPATH**/ ?>