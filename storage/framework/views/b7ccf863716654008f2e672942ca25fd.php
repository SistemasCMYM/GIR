...
<?php $__env->startSection('title', 'Dashboard - GIR-365'); ?>
        ...
        <div class="welcome-section animate-slide-up alaign-center">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    ...
                    <h1 class="welcome-title" id="greeting">Bienvenido/a, <?php echo e($userName); ?></h1>
                    <p class="welcome-subtitle">
                        ¡Damos la bienvenida al Sistema Integral de Gestión de Riesgos GIR-365 para la empresa:
                        <?php echo e($empresaName); ?> !
                    </p>
                    <p class="mb-0">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h4 class="mb-0"><?php echo e($totalHallazgos ?? 0); ?></h4>
                ...
                <div class="card silva-metric-card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h4 class="mb-0"><?php echo e($evaluacionesPsicosociales ?? 0); ?></h4>
                ...
                <div class="card silva-metric-card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h4 class="mb-0"><?php echo e($planesAccion ?? 0); ?></h4>
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <div class="mb-4">
                                            <span class="badge bg-soft-primary text-primary">
                                                ...
                                                <?php echo e($totalHallazgos ?? 190); ?> registros
                                            </span>
                                        </div>
                                        <a href="<?php echo e(route('hallazgos.index')); ?>" class="btn btn-primary">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <div class="mb-4">
                                            <span class="badge bg-soft-success text-success me-2">
                                                ...
                                                <?php echo e($evaluacionesCompletadas ?? 0); ?> completadas
                                            </span>
                                            <span class="badge bg-soft-warning text-warning">
                                                <i class="fas fa-clock me-1"></i>
                                                <?php echo e($evaluacionesPendientes ?? 0); ?> pendientes
                                            </span>
                                        </div>
                                        <a href="<?php echo e(route('psicosocial.index')); ?>" class="btn btn-primary">
                                            <i class="fas fa-arrow-right me-1"></i>
                                            Acceder
                                        </a>
                                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                <a href="<?php echo e(route('psicosocial.index')); ?>" class="text-decoration-none">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                <div class="d-grid">
                                    <a href="<?php echo e(route('hallazgos.create')); ?>" class="btn btn-primary btn-lg">
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="d-grid">
                                    <a href="<?php echo e(route('psicosocial.create')); ?>" class="btn btn-info btn-lg">
                            ...
                            <?php if($isSuperAdmin): ?>
                                <div class="col-md-3 mb-3">
                                    <div class="d-grid">
                                        <a href="<?php echo e(route('configuracion.index')); ?>" class="btn btn-secondary btn-lg">
    ...
    <script>
            ...
            if (riskCanvas) {
                ...
                new Chart(riskCtx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            data: [<?php echo e($riesgoCritico ?? 5); ?>, <?php echo e($riesgoAlto ?? 15); ?>,
                                <?php echo e($riesgoMedio ?? 25); ?>, <?php echo e($riesgoBajo ?? 35); ?>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateDateTime() {
                ...
                document.getElementById('greeting').textContent = `${greeting}, <?php echo e($userName); ?>`;
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\José Espinel\OneDrive - CM&M ASESORES DE SEGURO LIMITADA\Documentos - Grupo IT\APP-GIR365-V2\resources\views/dashboard.blade.php ENDPATH**/ ?>