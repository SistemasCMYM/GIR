    ...
    <style>
        ...
        * {
        ...
        .auth-layout {
            ...
            /* background: url('<?php echo e(asset('img/Element_Graphic_3840x2160.mp4')); ?>') no-repeat center center; */
...
<body>
    <div class="auth-layout">
        <video autoplay muted loop playsinline class="bg-video">
            <source src="<?php echo e(asset('img/Element_Graphic_3840x2160.mp4')); ?>" type="video/mp4">
        ...
        <div class="auth-card fade-in" data-aos="fade-up" data-aos-duration="600">
            ...
            <div class="auth-body" style="overflow-y: auto; max-height: calc(100vh - 140px); padding-right: 6px;">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="w-100">
                            ...
                            <div class="fw-bold text-truncate" style="font-size: clamp(10px, 2vw, 13px);">
                                <?php echo e($empresa['razon_social'] ?? 'Empresa no identificada'); ?>

                            </div>
                            <?php if(isset($empresa['nit'])): ?>
                                <small class="text-muted d-none d-sm-block" style="font-size: clamp(8px, 1.5vw, 10px);">NIT: <?php echo e($empresa['nit']); ?></small>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <?php endif; ?>
                <form method="POST" action="<?php echo e(route('login.credentials.verify')); ?>">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <a href="<?php echo e(route('login.nit')); ?>" class="btn-link-modern mt-3">
...
<?php /**PATH C:\Users\José Espinel\OneDrive - CM&M ASESORES DE SEGURO LIMITADA\Documentos - Grupo IT\APP-GIR365-V2\resources\views/admin/auth/credentials.blade.php ENDPATH**/ ?>