...
<?php $__env->startSection('page-title', 'Administración de Usuarios'); ?>
                    ...
                    <div class="card-body tw-flex tw-items-center tw-gap-4 tw-p-4 tw-h-full">
                        ...
                        <div class="flex-grow-1 tw-space-y-1">
                            <h4 class="mb-0 tw-text-2xl tw-font-semibold tw-text-gray-900">
                                <?php echo e($estadisticas['total_usuarios'] ?? 3); ?>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 mb-4">
                <div
                    ...
                    <div class="card-body tw-flex tw-items-center tw-gap-4 tw-p-4 tw-h-full">
                        ...
                        <div class="flex-grow-1 tw-space-y-1">
                            <h4 class="mb-0 tw-text-2xl tw-font-semibold tw-text-gray-900">
                                <?php echo e($estadisticas['total_roles'] ?? 0); ?>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 mb-4">
                <div
                    ...
                    <div class="card-body tw-flex tw-items-center tw-gap-4 tw-p-4 tw-h-full">
                        ...
                        <div class="flex-grow-1 tw-space-y-1">
                            <h4 class="mb-0 tw-text-2xl tw-font-semibold tw-text-gray-900">
                                <?php echo e($estadisticas['total_permisos'] ?? 8); ?>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 mb-4">
                <div
                    ...
                    <div class="card-body tw-flex tw-items-center tw-gap-4 tw-p-4 tw-h-full">
                        ...
                        <div class="flex-grow-1 tw-space-y-1">
                            <h4 class="mb-0 tw-text-2xl tw-font-semibold tw-text-gray-900">
                                <?php echo e($estadisticas['sesiones_activas'] ?? 6); ?>
            ...
            <div class="col-lg-3 col-md-6 mb-3">
                <div
                    ...
                    <div
                        ...
                        <a href="<?php echo e(route('usuarios.cuentas.index')); ?>" class="btn btn-primary tw-w-full tw-rounded-xl">
            ...
            <div class="col-lg-3 col-md-6 mb-3">
                <div
                    ...
                    <div
                        ...
                        <a href="<?php echo e(route('usuarios.perfiles.index')); ?>" class="btn btn-secondary tw-w-full tw-rounded-xl">
                            <i class="fas fa-arrow-right me-1"></i>
                            Acceder
                        </a>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 mb-3">
                <div
                    ...
                    <div
                        ...
                        <a href="<?php echo e(route('usuarios.roles.index')); ?>" class="btn btn-danger tw-w-full tw-rounded-xl">
                            <i class="fas fa-arrow-right me-1"></i>
                            Acceder
                        </a>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 mb-3">
                <div
                    ...
                    <div
                        ...
                        <a href="<?php echo e(route('usuarios.permisos.index')); ?>" class="btn btn-warning tw-w-full tw-rounded-xl">
                            <i class="fas fa-arrow-right me-1"></i>
                            Acceder
                        </a>
                    </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3 mb-3">
                        <div class="d-grid">
                            <a href="<?php echo e(route('usuarios.cuentas.create')); ?>" class="btn btn-outline-primary">
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="d-grid">
                            <a href="<?php echo e(route('usuarios.roles.create')); ?>" class="btn btn-outline-danger">
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="d-grid">
                            <a href="<?php echo e(route('usuarios.permisos.matrix')); ?>" class="btn btn-outline-warning">
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="d-grid">
                            <a href="<?php echo e(route('usuarios.auditoria')); ?>" class="btn btn-outline-secondary">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\José Espinel\OneDrive - CM&M ASESORES DE SEGURO LIMITADA\Documentos - Grupo IT\APP-GIR365-V2\resources\views/admin/gestion-administrativa/index.blade.php ENDPATH**/ ?>