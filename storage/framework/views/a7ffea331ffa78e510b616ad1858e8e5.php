    ...
    <nav class="navbar-modern" id="navbar">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center w-100">
                ...
                <a href="<?php echo e(route('login.nit')); ?>" class="btn-login">
                ...
                <div class="col-lg-6" data-aos="fade-right">
                    <div class="hero-content">
                        ...
                        <div class="hero-buttons">
                            <a href="<?php echo e(route('login.nit')); ?>" class="btn-hero-primary">
            ...
            <div class="contact-card" data-aos="fade-up">
                ...
                <div class="contact-info">
                    <div class="contact-item">
                        ...
                        <span><?php echo e(config('app.contact_email', 'info@tudominio.com')); ?></span>
                    </div>
                    <div class="contact-item">
                        <i class="fas fa-phone"></i>
                        <span><?php echo e(config('app.contact_phone', '+57 (1) 234-5678')); ?></span>
                    </div>
                    <div class="contact-item">
...
<?php /**PATH C:\Users\José Espinel\OneDrive - CM&M ASESORES DE SEGURO LIMITADA\Documentos - Grupo IT\APP-GIR365-V2\resources\views/admin/auth/landing.blade.php ENDPATH**/ ?>