    ...
    return _createClass(e, [{
        ...
        value: function() {
            ...
            t && t.addEventListener("click", function() {
                ...
                t = "primary",
                (n = document.createElement("div")).innerHTML = '<div class="alert alert-' + t + ' alert-dismissible" role="alert">' + e + '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>',
                a.append(n)
            })
        }
    }, {
        ...
        value: function() {
            ...
            $("#side-menu").length && ($("#side-menu li .collapse").on({
            ...
            $("#side-menu a").each(function() {
                ...
                (e = $(this).parent().parent().parent().parent().parent().parent().parent().parent().parent().parent()).is("body") || e.addClass("menuitem-active"))
            }))
        }
    }, {
        key: "init",
