...
@section('title', 'Administración de Empresa - GIR-365')
@section('page-title', 'Administración de Empresa')
                            ...
                            <div class="card tw-transition-transform tw-duration-300 hover:tw-scale-105">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h4 class="mb-0">{{ $totalCentros ?? 0 }}</h4>
                            ...
                            <div class="card tw-transition-transform tw-duration-300 hover:tw-scale-105">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h4 class="mb-0">{{ $totalProcesos ?? 0 }}</h4>
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card h-100 tw-transition-all tw-duration-300 hover:tw-shadow-lg">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        <span class="badge bg-primary">{{ $totalEmpleados ?? 0 }} empleados</span>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <a href="{{ route('empresa.empleados.index') }}"
                    ...
                    @if ($isSuperAdmin)
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div
                                ...
                                <div class="card-footer">
                                    <a href="{{ route('empresa.empresas.index') }}"
                            ...
                            <div class="card h-100 tw-transition-all tw-duration-300 hover:tw-shadow-lg">
                                ...
                                <div class="card-body">
                                    <p class="text-muted tw-text-sm">Define y organiza las áreas funcionales y
                                        ...
                                        empresa.</p>
                                    <div class="mb-3">
                                        <span class="badge bg-info">{{ $totalAreas ?? 0 }} áreas</span>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <a href="{{ route('empresa.areas.index') }}"
                            ...
                            <div class="card h-100 tw-transition-all tw-duration-300 hover:tw-shadow-lg">
                                ...
                                <div class="card-body">
                                    <p class="text-muted tw-text-sm">Administra las sedes, sucursales y centros de trabajo
                                        ...
                                        organización.</p>
                                    <div class="mb-3">
                                        <span class="badge bg-warning text-dark">{{ $totalCentros ?? 0 }} centros</span>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <a href="{{ route('empresa.centros.index') }}"
                    ...
                    @if ($isSuperAdmin || $isAdminEmpresa)
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card h-100 tw-transition-all tw-duration-300 hover:tw-shadow-lg">
                                ...
                                <div class="card-footer">
                                    <a href="{{ route('empresa.ciudades.index') }}"
                            ...
                            <div class="card h-100 tw-transition-all tw-duration-300 hover:tw-shadow-lg">
                                ...
                                <div class="card-body">
                                    <p class="text-muted tw-text-sm">Define los procesos organizacionales y procedimientos
                                        ...
                                        trabajo.</p>
                                    <div class="mb-3">
                                        <span class="badge bg-dark text-white">{{ $totalProcesos ?? 0 }} procesos</span>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <a href="{{ route('empresa.procesos.index') }}"
                        ...
                        <div class="col-12">
                            <div class="alert alert-warning tw-border-l-4 tw-border-yellow-500 tw-bg-yellow-50"
                                ...
                                <p class="mb-0">Como <strong>Profesional/Psicólogo</strong>, tu acceso a este módulo está
                                    limitado.
                                    Por favor, dirígete al <a href="{{ route('dashboard') }}" class="alert-link">Módulo
                                        Psicosocial</a>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-3 mb-3">
                                            <a href="{{ route('empresa.empleados.create') }}"
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <a href="{{ route('empresa.areas.create') }}"
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <a href="{{ route('empresa.centros.create') }}"
