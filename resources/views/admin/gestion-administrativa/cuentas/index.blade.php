                                        ...
                                        <tr style="border-bottom: 1px solid #f3f4f6; transition: all 0.2s;"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-2 tw-me-3">
                                                        <div class="rounded-full d-flex align-items-center justify-center text-white tw-w-6 tw-h-6 sm:tw-w-8 sm:tw-h-8 tw-text-xs"
                                                            ...
                                                            {{ strtoupper(substr($cuenta->nombre ?? 'N', 0, 1)) }}{{ strtoupper(substr($cuenta->apellido ?? 'A', 0, 1)) }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="tw-px-2 sm:tw-px-3 tw-py-1 sm:tw-py-2" style="border: none;">
                                                <span
                                                    ...
                                                    style="background: linear-gradient(135deg, var(--gir-gold-500) 0%, var(--gir-primary-light) 100%); color: white;">{{ Str::limit($cuenta->rol ?? 'Sin rol', 8) }}</span>
                                            </td>
                                            <td class="tw-px-2 sm:tw-px-3 tw-py-1 sm:tw-py-2" style="border: none;">
                                                @php
                                                ...
                                                @endphp
                                                <span
                                                    class="gir-badge-status {{ $badgeClass }} tw-text-xs tw-px-2 tw-py-1">
                                            ...
                                            <td class="tw-px-2 sm:tw-px-3 tw-py-1 sm:tw-py-2 tw-hidden lg:tw-table-cell"
                                                ...
                                                <div class="tw-text-xs tw-text-gray-500">
                                                    {{ isset($cuenta->ultimoAcceso) && $cuenta->ultimoAcceso ? \Carbon\Carbon::parse($cuenta->ultimoAcceso)->format('d/m/Y') : 'Nunca' }}
                                                </div>
                                            </td>
                                            ...
                                            <td class="tw-px-2 sm:tw-px-3 tw-py-1 sm:tw-py-2" style="border: none;">
                                                <div class="d-flex tw-gap-1">
                                                    ...
                                                    <a href="{{ route('usuarios.cuentas.edit', $cuenta->id) }}"
                                                        class="btn btn-sm d-flex align-items-center justify-content-center tw-w-6 tw-h-6 sm:tw-w-8 sm:tw-h-8"
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        onmouseout="this.style.background='transparent'"
                                                        onclick="toggleUserStatus('{{ $cuenta->id }}', '{{ $cuenta->estado }}')">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            btn.addEventListener('click', function(e) {
                ...
                $.ajax({
                    url: '{{ route('usuarios.cuentas.create') }}',
                    method: 'GET',
                    headers: {
