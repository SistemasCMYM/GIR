...
@section('page-title', 'Gestión de Instrumentos')
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h4 class="mb-0">{{ $stats['total_consentimientos'] ?? 0 }}</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h4 class="mb-0">{{ $stats['total_cuestionarios'] ?? 0 }}</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h4 class="mb-0">{{ $stats['total_encuestas'] ?? 0 }}</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h4 class="mb-0">{{ $stats['aplicaciones_activas'] ?? 0 }}</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="card h-100">
                            ...
                            <div class="card-footer">
                                <div class="d-grid gap-2">
                                    <a href="{{ route('gestion-instrumentos.encuestas.index') }}" class="btn btn-info">
