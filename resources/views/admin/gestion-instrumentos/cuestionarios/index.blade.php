                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <button class="btn btn-back btn-sm" data-bs-toggle="modal"
                                ...
                                <a href="{{ route('gestion-instrumentos.index') }}" class="btn-back">
                                ...
                                <tr class="cuestionario-datos">
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <a href="{{ route('gestion-instrumentos.cuestionarios.datos-generales') }}"
                                    ...
                                    <td>
                                        <small class="text-muted">
                                            <strong>Creado:</strong> {{ date('d/m/Y') }}<br>
                                            <strong>Modificado:</strong> {{ date('d/m/Y') }}
                                        </small>
                                    </td>
                                    <td>
                                ...
                                <tr class="cuestionario-intralaboral">
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <a href="{{ route('gestion-instrumentos.cuestionarios.intralaboral-forma-a') }}"
                                                    class="text-decoration-none fw-bold text-primary fs-6">
                                                    Intralaboral Forma A
                                                </a>
                                                <br>
                                ...
                                <tr class="cuestionario-intralaboral">
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <a href="{{ route('gestion-instrumentos.cuestionarios.intralaboral-forma-b') }}"
                                                    class="text-decoration-none fw-bold text-primary fs-6">
                                                    Intralaboral Forma B
                                                </a>
                                                <br>
                                ...
                                <tr class="cuestionario-extralaboral">
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <a href="{{ route('gestion-instrumentos.cuestionarios.extralaboral') }}"
                                                    class="text-decoration-none fw-bold text-primary fs-6">
                                ...
                                <tr class="cuestionario-estres">
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <a href="{{ route('gestion-instrumentos.cuestionarios.estres') }}"
                                                    class="text-decoration-none fw-bold text-primary fs-6">
