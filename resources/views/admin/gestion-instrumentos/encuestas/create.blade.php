...
@section('content')
    <div class="container-fluid py-4">
        ...
        <div class="wizard-container">
            ...
            <form id="encuestaForm" method="POST" action="{{ route('gestion-instrumentos.encuestas.store') }}">
                @csrf
    ...
    @push('scripts')
        ...
        <script>
            ...
            function guardarEncuesta() {
                ...
                fetch('{{ route('gestion-instrumentos.encuestas.store') }}', {
                        method: 'POST',
                        body: formData,
                        headers: {
                    ...
                    .then(data => {
                        if (data.success) {
                            Swal.fire({
                                ...
                                window.location.href = "{{ route('gestion-instrumentos.encuestas.index') }}";
                            });
                        } else {
                            Swal.fire({
                                title: 'Error',
